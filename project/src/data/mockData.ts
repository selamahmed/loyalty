...
export const inventory = [
  { id: '1', type: 'coupon', title: 'Free Espresso Shot', description: 'Valid for any espresso drink at participating café locations. Present this code to the barista.', expires: '2026-07-01', code: 'ESPRESSO2024', used: false, quantity: 1, image: 'https://images.pexels.com/photos/1514063/pexels-photo-1514063.jpeg?auto=compress&cs=tinysrgb&w=400', points: 150 },
  { id: '2', type: 'reward', title: 'Cappuccino Voucher', description: 'One free cappuccino, any size. Redeemable once per visit at any partner location.', expires: '2026-06-30', code: 'CAPPUCCINO42', used: false, quantity: 1, image: 'https://images.pexels.com/photos/3240797/pexels-photo-3240797.jpeg?auto=compress&cs=tinysrgb&w=400', points: 250 },
  { id: '3', type: 'reward', title: 'Croissant Voucher', description: 'Fresh baked croissant on the house. Available daily until stock lasts.', expires: '2026-07-15', code: 'CROISSANT99', used: false, quantity: 2, image: 'https://images.pexels.com/photos/11723395/pexels-photo-11723395.jpeg?auto=compress&cs=tinysrgb&w=400', points: 200 },
  { id: '4', type: 'coupon', title: '15% Off Any Item', description: 'Valid for one café menu item of your choice. Cannot be combined with other offers.', expires: '2026-08-20', code: 'CAFE15OFF', used: false, quantity: 3, image: 'https://images.pexels.com/photos/5491303/pexels-photo-5491303.jpeg?auto=compress&cs=tinysrgb&w=400', points: 180 },
  { id: '5', type: 'ticket', title: 'VIP Event Ticket', description: 'Exclusive access to the NexReward Summer Gala. One entry per code.', expires: '2026-08-01', code: 'VIP-GALA2026', used: false, quantity: 1, image: 'https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&cs=tinysrgb&w=400', points: 500 },
  { id: '6', type: 'coupon', title: 'Free Cold Brew', description: 'Smooth slow-steeped cold brew, on us. Valid for any size.', expires: '2026-07-10', code: 'COLDBREW22', used: false, quantity: 1, image: 'https://images.pexels.com/photos/7872846/pexels-photo-7872846.jpeg?auto=compress&cs=tinysrgb&w=400', points: 280 },
  { id: '7', type: 'reward', title: 'Iced Latte Voucher', description: 'Free iced latte, medium size. Redeemable at all participating stores.', expires: '2026-05-31', code: 'ICEDLATTE77', used: true, quantity: 1, image: 'https://images.pexels.com/photos/3980328/pexels-photo-3980328.jpeg?auto=compress&cs=tinysrgb&w=400', points: 300 },
];
