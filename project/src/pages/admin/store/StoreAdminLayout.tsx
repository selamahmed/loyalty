...
const StoreAdminLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen" style={{ background: '#f0fdf4' }}>
      ...
      <aside className={`fixed left-0 top-0 h-full w-64 z-50 flex flex-col overflow-y-auto transform transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static`}
        ...
        <div className="p-5" style={{ borderBottom: '2.5px solid #1e1b4b' }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-black text-sm" style={{ color: '#1e1b4b' }}>Mağaza Paneli</h1>
        ...
        <div className="mx-3 mt-4 mb-2 px-3 py-2.5 rounded-xl flex items-center gap-2"
          style={{ background: '#f0fdf4', border: `2px solid ${ACCENT}` }}>
